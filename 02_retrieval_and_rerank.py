...
# 答：它是目前开源界最强的多语言 Rerank 模型之一，对垂直领域的长文本重排效果极佳。
...
if __name__ == "__main__":
    ...
    print("正在加载 Rerank 模型 (初次运行需下载约 2GB，请耐心等待)...")
    # 加载 Cross-Encoder 模型，放到显卡上
